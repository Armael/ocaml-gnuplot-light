...
(* OASIS_START *)
(* DO NOT EDIT (digest: 503e9f1a66c54e19ea8ecee1af079b0e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/ogu/gnuplot-ocaml";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("threads", None)];
                      bs_build_tools =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "gnuplot"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "simple_plot.ml"});
               Executable
                 ({
                     cs_name = "gaussian_noise";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "gaussian_noise.ml"});
               Executable
                 ({
                     cs_name = "gbm_paths";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "gbm_paths.ml"});
               Executable
                 ({
                     cs_name = "candlesticks";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "candlesticks.ml"});
               Executable
                 ({
                     cs_name = "supply_demand";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "supply_demand.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Gp-OCaml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "A\231zq\189\242>\191\234\139I\030l\2320\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
